    ...
    for onset in onset_file:
        ...
        subprocess.run(
            [
                "mv",
                os.path.join("output", "tmp3.wav"),
                os.path.join("output", f"output_{formatted_i}.wav"),
            ]
        )
